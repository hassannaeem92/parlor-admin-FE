  ...
  let items = [
    {
      ...
      icon: "pi pi-pencil",
      command: () => {
        navigate(`/edit-deals/${selectedItem?.id}`);
      },
    },
    {
      label: "Delete",
    ...
    <div>
      <div className="card shadow-sm">
        <DataTable
          ...
          onRowClick={(e) => navigate("/edit-deals/" + e.data.id)}
        ...
        >
          ...
          <Column field="deal_name" sortable header="Deal Name" />
          <Column field="deal_description" sortable header="Deal Description" />
          <Column field="deal_price" sortable header="Deal Price" />
          {/* <Column
            field="created_at"
            sortable
            header="Date"
